...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "A 25-year journey of nurturing minds and shaping leaders." },
...
function AboutPage() {
  return (
    <Layout>
      <PageHero eyebrow="About Us" title="A legacy of learning, a future of leaders." subtitle="Twenty-five years of shaping minds, hearts, and characters." image={heroCampus} />
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="mt-6 space-y-4 text-muted-foreground leading-relaxed">
            <p>Akshara School was founded in 1998 by a small group of educators who believed that every child deserved an education that was rigorous, joyful, and rooted in values. The word <em className="text-primary not-italic font-semibold">akshara</em> means "the imperishable" — and it captures our conviction that what we teach must endure long after the school bell rings.</p>
            <p>Today, with over 3,500 students across pre-primary to senior secondary, Akshara stands as one of the most respected CBSE institutions in the region. Our alumni serve as doctors, engineers, artists, entrepreneurs, and changemakers across the globe — but more importantly, as kind, capable human beings.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 max-w-3xl text-center">
          <div className="text-gold uppercase tracking-[0.25em] text-xs font-semibold mb-3">Message from the Principal</div>
          <h2 className="font-display text-3xl md:text-4xl font-bold text-primary">"Education is not the filling of a pail, but the lighting of a fire."</h2>
          <p className="mt-6 text-muted-foreground leading-relaxed">
            At Akshara, we have spent twenty-five years lighting fires — of curiosity, of compassion, of courage. We invite you to walk through our gates, meet our teachers, and see how children flourish when they are seen, heard, and challenged. Welcome home.
          </p>
          <p className="mt-6 font-display text-lg text-primary font-semibold">— Dr. Lakshmi Narayanan, Principal</p>
        </div>
      </section>
    </Layout>
  );
