  ...
  return (
    <footer className="bg-primary text-primary-foreground mt-20">
      <div className="container mx-auto px-6 py-16 grid md:grid-cols-4 gap-10">
        <div>
          <div className="font-display text-2xl font-bold mb-3">Akshara School</div>
          <p className="text-sm text-primary-foreground/70 leading-relaxed">
            Nurturing curious minds, compassionate hearts, and confident futures since 1998.
          </p>
          <div className="flex gap-3 mt-5">
            <a href="#" className="h-9 w-9 rounded-full bg-primary-foreground/10 hover:bg-gold hover:text-gold-foreground grid place-items-center transition-colors"><Facebook className="h-4 w-4" /></a>
            <a href="#" className="h-9 w-9 rounded-full bg-primary-foreground/10 hover:bg-gold hover:text-gold-foreground grid place-items-center transition-colors"><Instagram className="h-4 w-4" /></a>
            <a href="#" className="h-9 w-9 rounded-full bg-primary-foreground/10 hover:bg-gold hover:text-gold-foreground grid place-items-center transition-colors"><Youtube className="h-4 w-4" /></a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-primary-foreground/70">
            ...
            <li>Senior Secondary (Grades 9–12)</li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-primary-foreground/80">
            <li className="flex gap-2"><MapPin className="h-4 w-4 mt-0.5 shrink-0 text-gold" /> Plot 24, Education Lane, Hyderabad, TS 500032</li>
            <li className="flex gap-2"><Phone className="h-4 w-4 mt-0.5 shrink-0 text-gold" /> +91 98765 43210</li>
            <li className="flex gap-2"><Mail className="h-4 w-4 mt-0.5 shrink-0 text-gold" /> admissions@aksharaschool.in</li>
          </ul>
        </div>
      </div>
